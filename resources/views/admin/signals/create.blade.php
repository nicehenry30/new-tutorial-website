    ...
    <main class="flex-1 p-6">
      ...
      {{-- Add Signal Form --}}
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            <h2 class="text-xl font-semibold mb-4">Add New Signal</h2>
            ...
            <div class="flex space-x-4">
                ...
                <input type="text" name="tp" id="name" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300"  required>
                @error('tp')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                </div>
                ...
                <input type="text" name="sl" id="name" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300"  required>
                @error('sl')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                </div>
            ...
            <div class="flex space-x-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="monthly_price" id="name" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
                     @error('monthly_price')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="text" name="yearly_price" id="name" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:border-blue-300" required>
                     @error('yearly_price')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            </div>
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">Add Signal</button>
            </form>
